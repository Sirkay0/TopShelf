    ...
    <div className="flex flex-col gap-10 p-6   bg-[conic-gradient(from_180deg,#05422C_83%,#648A7C_99%)] -mx-8 md:mx-0 min-[1180]:rounded-3xl min-[1180]:flex-row min-[1180]:gap-0 min-[1180]:justify-between min-[1180]:py-14 min-[1180]:pl-14 min-[1180]:pr-[88px]">
            ...
            <div className="flex gap-2 items-center">
              <div className="flex gap-1.5 items-center ">
                <img
                  ...
                  className="w-3 h-3"
                />
                <p className="text-[14px] leading-[150%] text-white ">{featuredProducts[currentIndex].rating}/5</p>
              </div>
              <div className="h-3 w-px bg-white/25 "></div>
              <div className="flex gap-1.5 items-center">
                <p className="text-[14px] leading-[150%] text-white ">{featuredProducts[currentIndex].reviews}</p>
        ...
        <div className="flex flex-col gap-4  min-[1180]:w-2/5">
          <div className="flex items-center justify-center bg-white/12 rounded-2xl h-[322px]  relative">
            ...
            <button className="w-9 h-9 rounded-[100px] bg-white drop-shadow-[0_6px_16px_rgba(0,0,0,0.9)] absolute   top-[145px] -left-3.5  flex items-center justify-center">
              <img
            ...
            <button onClick={next} className="w-9 h-9 rounded-[100px] bg-white drop-shadow-[0_6px_16px_rgba(0,0,0,0.9)] absolute  top-[145px] -right-3.5  flex items-center justify-center">
