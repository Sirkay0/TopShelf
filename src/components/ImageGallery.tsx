  ...
  return (
    <div className="flex flex-col gap-4 md:gap-6 md:items-center w-full md:w-1/2 items-start">
      <div className="w-full h-[342px] md:h-[520px] flex items-center justify-center border border-[#F4F4F4] rounded-2xl relative">
        ...
        <button className="absolute right-4 bottom-4 md:right-6 md:bottom-6 w-8 h-8 md:w-10 md:h-10 flex items-center justify-center bg-white rounded-[100px] drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)]">
          <div className="relative aspect-square h-4 md:h-5">
            <Image src="/assets/icons/export.svg" alt="Full Sreen Icon" fill />
          </div>
        </button>
      </div>
      <div className="flex flex-wrap gap-4 items-start w-full md:justify-center">
        {Images.map((image, index) => (
          <div
            ...
            className={`w-14 h-14  md:w-16 md:h-16 bg-[#F4F4F4] flex items-center justify-center rounded-lg
