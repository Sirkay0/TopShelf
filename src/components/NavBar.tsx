...
const NavBar = () => {
  ...
  return (
    <header className="fixed flex flex-col top-0 left-0 bg-white pb-4 w-full z-1000">
      <Notification />
      <div className="flex   flex-wrap pt-3.5 px-6 md:px-16 ">
        <div className="flex gap-4 items-center justify-start w-1/2 md:order-1  pb-5  md:pb-0 md:w-1/4">
          <button
            ...
            className="flex flex-col gap-1.5 group md:hidden"
          >
            <span
        ...
        <div className="w-full pt-5 flex items-center justify-center gap-4 px-10 md:order-2 md:px-0 md:pt-0 border-t border-gray-300 md:border-none md:w-2/4 ">
          ...
          />
          <button className="h-10 w-10 bg-button-green flex justify-center items-center rounded-full">
            <img
      ...
      <div
        className={`absolute bg-secondary top-0 right-0 w-64 h-screen opacity-60 shadow-lg transform  transition-transform duration-300 ${
          open ? "translate-x-0 " : "translate-x-64"
        } 
        md:static md:transform-none md:translate-x-0 md:h-auto md:opacity-100 md:bg-white md:shadow-none md:w-full md:py-4 px-16 `}
      >
